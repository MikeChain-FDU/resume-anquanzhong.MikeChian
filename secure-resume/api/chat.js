export default async function handler(req, res) {
  ...
  try {
    ...
    // 🧠 核心稳定机制：将人设作为对话的第一轮，彻底抛弃容易报错的 systemInstruction 字段
    ...
    // 🚀 核心路由修复：改回 v1beta 接口，这个接口 100% 能找到 gemini-1.5-flash 模型
    ...
    const response = await fetch(url, {
      ...
      body: JSON.stringify({
        contents: robustContents // 这里只传标准对话数组，不传 systemInstruction
      })
    });
